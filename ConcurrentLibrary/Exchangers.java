...
class FirstExchangerWorker implements Runnable {
...
class SecondExchangerWorker implements Runnable {

	private int counter;
	private Exchanger<Integer> exchanger;

	public SecondExchangerWorker(Exchanger<Integer> exchanger) {
		this.exchanger = exchanger;
	}
...
public class Exchangers {
	...
	public static void main(String[] args) {
		...
		new Thread(new FirstExchangerWorker(exchanger)).start();
		new Thread(new SecondExchangerWorker(exchanger)).start();
